...
Vue.component("top-navigator", {
    ...
    <nav class="navigator" role="navigation">
        ...
        <p class="vertime">Pre-Alpha 0.0.11<br>Y{{ year }} {{ season }} D{{ total_day }} {{ hour }}:{{ minute }}</p>
        ...
        <a href="blog.html?id=1"><img src="civitas/svg/common/blog.svg" width="22px" height="22px"/>开发日志</a>
